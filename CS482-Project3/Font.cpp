...
/* 'FontDelete()' - Delete the specified font. */
void FontDelete(GLFONT *font) /* I - Font to delete */
{
	if (font == (GLFONT *)0)
		return;
...
void FontPuts(GLFONT     *font, /* I - Font to use */
	...
	...)                /* I - Other arguments as necessary */
{
	...
	/* Format the string */
	va_start(ap, format);
	vsprintf_s((char *)s, 100, format, ap);
	va_end(ap);
